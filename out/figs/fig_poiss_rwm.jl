...
df = DataFrame(CSV.File(srcdir*"rwm_poisson_r_d.csv"; header=false))
g1 = Matrix(df)
...
p = plot(p1,p2, plot_title = "Poisson regression - Online-Picard RWM", size=(800,400), bottom_margin = 3mm, left_margin = 3mm)
savefig("poisson_rwm.pdf")