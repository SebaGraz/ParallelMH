...
df = DataFrame(CSV.File(srcdir*"mwg_lin_r_d.csv"; header=false))
g1 = Matrix(df)
...
p = plot(p1,p2, plot_title = "Linear regression - Online-Picard MwG", size=(800,400),  bottom_margin = 3mm,  left_margin = 3mm)
savefig("lin_mwg.pdf")