...
res, W = online_picard_rwm(T, x0, h1, K, Niter, 0.0; save = true);
@show res.acc
...
writedlm("SIR1.csv", res.XX[:,Niter  ÷ 2:100:end], ',')
...
writedlm("SIR2.csv", res1.XX[:,Niter  ÷ 2:100:end], ',')
...
writedlm("SIR3.csv", M[:,Niter  ÷ 2:100:end], ',')
error("")
